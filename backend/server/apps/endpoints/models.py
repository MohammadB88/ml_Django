...
# Create your models here. Three models will be created:
...
class Endpoint(models.Model):
   ...
   Attributes:
	...
	created_at: he date when endpoint was created.
   '''
...
class MLAlgorithm(models.Model):
   '''
   The MLAlforithm represent the ML algorithm object.
...
# MLAlgorithmStatus model
class MLAlgorithmStatus(models.Model):
   '''
   The MLAlgorithmStatus represnt status of the MLAlgorithm which can change 
   during the time.
...
class MLRequest(models.Model):
   ...
   Attributes:
	...
	full_response: The reponse of the ML algorithm.
